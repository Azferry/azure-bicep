...
var appServicePlanName = 'demo-asp-dev-eus2-001'
var appInsightsName = 'demo-appi-dev-eus2-001'
var storageAccountName = 'demostdeveus2001'
var vnetname = 'vnet-dev-eus2-001'

var vnetID = '/subscriptions/16632089-aa31-498a-8b82-39b0405c4c55/resourceGroups/demo-rg-eus2-dev/providers/Microsoft.Network/virtualNetworks/vnet-dev-eus2-001/subnets/snet-functionapp'

var functionPlanKind = (functionPlanSkuName == 'Y1') ? 'functionapp' : 'elastic'
var functionName = 'HttpTriggeredFunction'
...
resource vnetConnection 'Microsoft.Web/sites/virtualNetworkConnections@2020-12-01' = {
  name: '${functionApp}/VirtualNetwork'
  properties: {
...
resource function1 'Microsoft.Web/sites/functions@2020-06-01' = {
  name: 'temp'
  parent: functionApp
  properties: {
    config: {
